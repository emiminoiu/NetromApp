...
namespace WebApp.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        //public async Task<IActionResult> SS(string searchString)
        //{

        //    var announcesWebsiteContext = _context.Announce.Include(a => a.Category).Include(a => a.User).Include(a => a.Comment);
        //   var announce = from Category in announcesWebsiteContext select Announces;
        //    if (!String.IsNullOrEmpty(searchString))
        //    {
        //       announce = announcesWebsiteContext.Where(s => s.CategoryName.Equals(searchString) && (s.ExpiringDate > DateTime.Now));
        //   }
